...
const BENEFITS = [
  ...
  },
  {
    ...
    title: "미디어킷 자동화",
    description: "실시간 데이터로 미디어킷을 자동 업데이트하여 항상 최신 정보를 유지합니다.",
  },
  {
        ...
        <div className="w-full max-w-lg">
          {isConnected ? (
            ...
            <div className="text-center space-y-6">
              ...
              <Link
                href="/dashboard/creator"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-pink text-white font-medium hover:opacity-90 transition-opacity"
              >
                대시보드 바로가기
              </Link>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#f09433] via-[#dc2743] to-[#bc1888] text-white font-semibold text-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                >
