        ...
        <div className="max-w-xl mx-auto">
          {!submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0a0a0f] border border-[#2a2a3e] rounded-lg px-4 py-3 text-[#e4e4e7] focus:outline-none focus:border-[#7c3aed] focus:ring-1 focus:ring-[#7c3aed]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#e4e4e7] mb-1.5">
                    전화번호 <span className="text-[#a1a1aa] text-xs">(선택)</span>
                  </label>
                  <input
                    value={form.phone}
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#0a0a0f] border border-[#2a2a3e] rounded-lg px-4 py-3 text-[#e4e4e7] focus:outline-none focus:border-[#7c3aed] focus:ring-1 focus:ring-[#7c3aed] appearance-none"
                  >
                    <option>5명 이하</option>
                    <option>6~20명</option>
                ...
                <div>
                  <label className="block text-sm font-medium text-[#e4e4e7] mb-1.5">
                    문의 내용 <span className="text-[#a1a1aa] text-xs">(선택)</span>
                  </label>
                  <textarea
                    rows={4}
                    value={form.message}
                    onChange={(e) => setForm({ ...form, message: e.target.value })}
                    className="w-full bg-[#0a0a0f] border border-[#2a2a3e] rounded-lg px-4 py-3 text-[#e4e4e7] focus:outline-none focus:border-[#7c3aed] focus:ring-1 focus:ring-[#7c3aed] resize-none"
            ...
            <div className="text-center py-20">
              ...
              <h2 className="text-2xl font-bold text-[#e4e4e7] mb-3">문의가 접수되었습니다</h2>
