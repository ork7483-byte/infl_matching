              ...
              <div className="flex-1 min-w-0">
                <div className="bg-white border border-[#E5E7EB] rounded-2xl p-8">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-[#7c3aed] text-white font-semibold px-6 py-3 rounded-xl text-base hover:opacity-90 transition-opacity min-h-[48px] cursor-pointer w-full sm:w-auto"
                  >
                    사용하기 →
                  </Link>
                </div>
