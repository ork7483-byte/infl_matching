        ...
        <section className="pt-32 pb-20 px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-6 leading-tight">
              <span className="text-[#111827]">실시간 성과 분석 &</span>
              <br />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {metrics.map((m) => (
                <div
                  key={m.label}
                  className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-2xl p-8 text-center"
                >
                  <div className="text-4xl font-bold bg-gradient-to-r from-[#7c3aed] to-[#e94560] bg-clip-text text-transparent mb-2">
                    {m.value}
                  </div>
                  <div className="text-[#111827] font-semibold mb-1">{m.label}</div>
                  <div className="text-[#6B7280] text-sm">{m.sub}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-2xl p-8 relative">
              ...
              <div className="flex items-center gap-6 mb-8">
                <div>
                  <div className="text-[#111827] font-semibold mb-1">캠페인 성과 추이</div>
                  <div className="text-[#6B7280] text-sm">최근 30일</div>
                </div>
              ...
              <div className="relative h-48 mb-6">
                {/* Y-axis labels */}
                <div className="absolute left-0 top-0 h-full flex flex-col justify-between text-[#6B7280] text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                {[
                  ...
                  >
                    <div className="text-[#6B7280] text-xs mb-1">{stat.label}</div>
                    <div className="text-[#111827] font-bold text-lg">{stat.value}</div>
