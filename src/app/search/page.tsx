  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-[#1a1a2e] to-[#0a0a0f] border-b border-[#2a2a3e] py-12 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-3xl sm:text-4xl font-bold text-[#e4e4e7] mb-3 leading-tight">
              데이터로 검증된{" "}
              <span className="bg-gradient-to-r from-[#7c3aed] to-[#e94560] bg-clip-text text-transparent">
                인플루언서
              </span>
